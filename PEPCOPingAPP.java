 ...
 */
public class PEPCOPingAPP extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("PEPCO PingApp -> PL-IT (V1.2)");
        ...
        PEPCOPingAPP.Clicklistener click = new PEPCOPingAPP.Clicklistener();
        ...
        {public void mouseClicked(MouseEvent e0) {Short(dirToOpenBOS);}
        });
            ...
            public void mouseClicked(MouseEvent e17)
            {
                if (Desktop.isDesktopSupported()) {
                    ...
                    if (d.isSupported(Desktop.Action.MAIL)) {
                        try {
                            d.mail(new URI("mailto:pczernicki@pepco.eu?subject=Problem%20With%20PingAPP&body=Hi!%0AThere%20is%20a%20problem%20with%20PingAPP(PL-IT):%20"));
                        } catch (IOException e) {
                            e.printStackTrace();
    ...
    PEPCOPingAPP.P1 wone = new PEPCOPingAPP.P1();//SwingWorker1
    PEPCOPingAPP.P2 wtwo = new PEPCOPingAPP.P2();//SwingWorker2
    PEPCOPingAPP.P3 wthree = new PEPCOPingAPP.P3();//SwingWorker3
    PEPCOPingAPP.P4 wfour = new PEPCOPingAPP.P4();//SwingWorker4
    PEPCOPingAPP.P5 wfive = new PEPCOPingAPP.P5();//SwingWorker5
    PEPCOPingAPP.P6 wsix = new PEPCOPingAPP.P6();//SwingWorker6
    ...
    public class Clicklistener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == StartButton) {
                ...
                IPEFT3.setText(values[0] + "." + values[1] + "." + values[2] + ".68");
                IPEFT4.setText(values[0] + "." + values[1] + "." + values[2] + ".69");
